                                    ...
                                    <div class="form-group form__width">
                                        <div class="checkbox__input">
                                            <div class="pretty p-default p-thick p-smooth">
                                                <input type="radio" name="voluntario_autovistoria" value="voluntario"
                                                       id="voluntario" onclick="ShowHideDiv()"/>
                                                <div class="state p-warning-o">
                                                    <label for="voluntario">Voluntário</label>
                                                </div>
                                            </div>
                                            <div class="pretty p-default p-thick p-smooth">
                                                <input type="radio" name="voluntario_autovistoria" value="autovistoria"
                                                       id="autovistoria" onclick="ShowHideDiv()"/>
                                                <div class="state p-warning-o">
                                    ...
                                    <div class="form-group mt-5">
                                        ...
                                        <div class="input__extra" id="imovel-publico-content">
                                            ...
                                            <div class="radio__group">
                                                <div class="radio__content">
                                                    <label>
                                                        <input type="radio" name="tipoimovelpublico"
                                                               value="imovel-publico-clinica">
                                                        <div class="radio__item">
                                                            <img src="https://www.flaticon.com/svg/static/icons/svg/25/25694.svg"
                                                                 alt="">
                                ...
                                <div class="fase4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="text-center w-100">Qual tipo predominante de ar
                                            condicionado? </label>
                                        <select name="qual_tipo_predominante_de_ar_condicionado" id=""
                                                class="input__rio--select">
                                    ...
                                    <div class="form-group w-75 m-auto">
                                        ...
                                        <div class="input__text">
                                            ...
                                            <input type="text" class="input__rio"
                                                   name="idade_media_dos_equipamentos_de_ar_condicionado">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="checkbox__input">
                                ...
                                <div class="fase5">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="text-center w-100">Qual tipo de iluminação
                                            predominante?</label>
                                        <select name="qual_o_tipo_de_iluminacao_predominante" id=""
                                                class="input__rio--select">
                                ...
                                <div class="fase6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox__input">
                                            <div class="pretty p-default p-thick p-smooth">
                                                <input type="radio"
                                                       name="possui_paineis_solares_para_aquecimento_de_agua"
                                                       value="sim" id="sim"/>
                                                <div class="state p-warning-o">
                                                    <label for="sim">Sim</label>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input__text">
                                            ...
                                            <input type="text" class="input__rio"
                                                   name="area_total_disponivel_na_coberturatelhados">
                                        </div>
                                    </div>
                                </div>
                            </section>
