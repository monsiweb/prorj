                ...
                <div id="form-prorio-content">
                            ...
                            <div class="form-group form__width">
                                <div class="checkbox__input">
                                    <div class="pretty p-default p-thick p-smooth">
                                        <input type="radio" name="voluntario-autovistoria" value="voluntario" id="voluntario" onclick="ShowHideDiv()" />
                                        <div class="state p-warning-o">
                                            <label for="voluntario">Voluntário</label>
                                        </div>
                                    </div>
                                    <div class="pretty p-default p-thick p-smooth">
                                        <input type="radio" name="voluntario-autovistoria" value="autovistoria" id="autovistoria" onclick="ShowHideDiv()" />
                                        <div class="state p-warning-o">
                            ...
                            <div class="form-group mt-5">
                                ...
                                <div class="radio__group form__width--two mt-5">
                                    <div class="radio__content">
                                        <label>
                                            <input type="radio" name="tipoimovel" value="imovel-residencial" id="imovel-residencial" onclick="ShowHideDiv()">
                                    ...
                                    <div class="radio__content">
                                        <label>
                                            <input type="radio" name="tipoimovel" value="imovel-publico" id="imovel-publico" onclick="ShowHideDiv()">
                                            <div class="radio__item">
                                                <img src="https://www.flaticon.com/svg/static/icons/svg/25/25694.svg" alt="">
                                    ...
                                    <div class="radio__content">
                                        <label>
                                            <input type="radio" name="tipoimovel" value="imovel-comercial" id="imovel-comercial" onclick="ShowHideDiv()">
                                            <div class="radio__item">
                                                <img src="https://www.flaticon.com/svg/static/icons/svg/25/25694.svg" alt="">
                    ...
                    <section>
                        <div class="fase4">
                            ...
                            <div class="form-group">
                                <label for="" class="text-center w-100">Qual tipo predominante de ar condicionado? </label>
                    ...
                    <section>
                        <div class="fase5">
                            ...
                            <div class="form-group">
                                <label for="" class="text-center w-100">Qual tipo de iluminação predominante?</label>
